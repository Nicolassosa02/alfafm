    ...
    $(e).click(function() {
        ...
        if (t.match("#(.+)")) {
            ...
            if ($("#" + t).length > 0) {
                r = "#" + t;
                e = true
            } else if ($("a[name=" + t + "]").length > 0) {
                r = "a[name=" + t + "]";
                e = true
            }
            if (e) {
                $("html, body").animate({
                    scrollTop: $(r).offset().top - 72
                }, "slow");
                return false
            }
        }
...
/**
	 * drPlayer
	 * http://www.devreactor.com/projects/drplayer.aspx
	 */
...
(function($) {
    ...
    function setPlayer(el, url, id, settings) {
        ...
        var settingsStr = "&amp;backgroundColor=" + settings.backgroundColor + "&amp;volumeBarWidth=" + settings.volumeBarWidth + "&amp;progressBarWidth=" + settings.progressBarWidth + "&amp;barSpace=" + settings.barSpace + "&amp;volumeBarColor=" + settings.volumeBarColor + "&amp;volumeBarHeight=" + settings.volumeBarHeight + "&amp;volumeSliderWidth=" + settings.volumeSliderWidth + "&amp;volumeSliderHeight=" + settings.volumeSliderHeight + "&amp;volumeSliderColor=" + settings.volumeSliderColor + "&amp;progressBarHeight=" + settings.progressBarHeight + "&amp;progressSliderWidth=" + settings.progressSliderWidth + "&amp;progressSliderHeight=" + settings.progressSliderHeight + "&amp;progressSliderColor=" + settings.progressSliderColor + "&amp;progressBarColor=" + settings.progressBarColor + "&amp;bufferColor=" + settings.bufferColor;
    ...
    var methods = {
        ...
        init: function(options) {
            ...
            var settings = {
                ...
                barSpace: 0,
                volumeBarColor: 0xCCCCCC,
                volumeBarWidth: 0,
                volumeBarHeight: 0,
                volumeSliderWidth: 10,
                volumeSliderHeight: 5,
                volumeSliderColor: 0xCCCCCC,
                progressBarWidth: 584,
                progressBarHeight: 28,
                progressBarColor: 0xCCCCCC,
                progressSliderWidth: 4,
                progressSliderHeight: 28,
                progressSliderColor: 0xCCCCCC,
                bufferColor: 0xEEEEEE,
...
/**
 * jQuery NiceScroll 3.6.0 InuYaksa
